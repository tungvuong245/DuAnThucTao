...
import com.example.lasthope.databinding.LayoutNotificationInputBinding;
...
public abstract class BaseFragment extends Fragment {
    ...
    public void replaceFragment(Fragment fragment) {
        getParentFragmentManager().beginTransaction().replace(R.id.fade_control, fragment).addToBackStack(null).commit();
    }
