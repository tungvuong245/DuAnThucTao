...
import com.example.lasthope.databinding.ActivitySignUpBinding;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            User user = new User(FirebaseAuth.getInstance().getCurrentUser().getUid(), binding.name.getText().toString(), null, "", "", binding.address.getText().toString(),
