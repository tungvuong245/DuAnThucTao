...
public class AddProductFragment extends BaseFragment {
    ...
    private void saveProduct(Context context){
            ...
            Product product = new Product(key,binding.edNameProduct.getText().toString().trim(),Integer.parseInt(binding.edSoluong.getText().toString()),binding.edDescribe.getText().toString().trim(),typeProduct, Double.parseDouble(binding.edPrice.getText().toString().trim()), binding.edNote.getText().toString().trim(),true);
            ...
            builder.setPositiveButton("Đồng ý", new DialogInterface.OnClickListener() {
                ...
                if(imgProduct != null){
                    ...
                    storageReference.putFile(imgProduct).addOnSuccessListener(taskSnapshot -> {
                        Log.e("Anh", "onClick: cap nhat anh thanh cong" );
    ...
    private void requestPermission() {
        ...
        if (ContextCompat.checkSelfPermission(requireContext(),
            ...
            Log.d("TAG", "requestPermission: 2");
            addImage();
        }
    }

    private void addImage() {
        Log.e("TAG", "addImage: 3");
