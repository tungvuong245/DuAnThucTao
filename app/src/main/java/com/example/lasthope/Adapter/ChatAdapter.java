...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolderLeft> {
    ...
    public ViewHolderLeft onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ChatAdapter.ViewHolderLeft(ItemChatLeftBinding.inflate(LayoutInflater.from(parent.getContext()),parent,false));
    }
